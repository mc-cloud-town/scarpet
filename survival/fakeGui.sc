// 原出處: https://github.com/gnembon/scarpet/blob/master/programs/survival/fakeplayer_inv_editor.sc
...
global_languages = {
    ...
    'en_us' -> {
        'usage' -> '\nUsage:\n    Crouch down and right click on the fake player\nor:\n    Execute command /fakegui <player>',
...
__on_player_interacts_with_entity(creativeplayer, fakeplayer, hand) -> if (
    creativeplayer~'pose' == 'crouching' && creativeplayer~'player_type' != 'fake' && creativeplayer != fakeplayer && fakeplayer~'player_type' == 'fake' && hand == 'mainhand',
